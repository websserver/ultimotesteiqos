...
const BASE_SCALE = 4;  // Escala base ajustada para 4
const SELECTED_SCALE = 5.0;  // Escala quando selecionado em 6
const MODEL_NAMES = {
  0: "IQOS ILUMA",
  1: "IQOS ILUMA PRIME",
  2: "IQOS ILUMA ONE"
...
function showModelInfo(modelId) {
    ...
    modelInfo.innerHTML = `
        ...
        <button class="pulse-button" onclick="window.location.href='${modelConfig.link}'">Personalizar</button>
    `;
